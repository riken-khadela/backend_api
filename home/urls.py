...
urlpatterns = [
    ...
    #path('api/get-youtube-tags/', YouTubeHashTag.as_view(), name='get-youtube-tags'), # Function changed By Adil
    path('api/get-youtube-tags/', GetYouTubeTagsView.as_view(), name='get-youtube-tags'), # Function changed By Adil
